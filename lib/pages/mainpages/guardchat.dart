...
class _GuardChatPageState extends State<GuardChatPage> {
  ...
  void _fetchMessages() async {
    try {
      final List<dynamic> fetchedMessages =
          await messageService.getMessagesGuard();
      ...
      setState(() {
        ...
        messages.addAll(
          fetchedMessages.map<Map<String, dynamic>>((msg) {
            ...
            if (msg['sender_role'] == 'guard' && msg['is_seen'] == 0) {
  ...
  void _sendMessage() async {
    if (_controller.text.isNotEmpty) {
      ...
      final String recipientRole = 'guard'; // Set this based on your logic
      ...
      try {
        await messageService.sendMessageGuard(message, recipientRole);
      } catch (e) {
                  ...
                  child: Align(
                    ...
                    child: Row(
                      mainAxisAlignment: isHomeOwner
                          ? MainAxisAlignment.end // Align messages to the right
                          : MainAxisAlignment
                      ...
                      children: [
                        Flexible(
                          child: Column(
                            ...
                            children: [
                              // Display guard name if available
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isHomeOwner
                                      ? Colors
                                          .grey[200] // Customize for homeowner
                                      : Colors.grey[200], // Customize for admin
                              ...
                              const SizedBox(height: 5),
                              if (messages[index]['guard_name'] != null)
                                Text(messages[index]['guard_name'],
                                    style: const TextStyle(
